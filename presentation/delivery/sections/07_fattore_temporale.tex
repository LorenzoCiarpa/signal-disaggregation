...
\section{Il caso \texorpdfstring{$w = 0$}{w = 0}}

Con $w = 0$ il pavimento scompare e la~\eqref{eq:fattore} si riduce alla formulazione senza
specificità: fattore nullo dentro la fascia e penalità graduata soltanto fuori, con gli apparecchi
senza fascia che non pagano nulla, a nessuna ora. È il comportamento discusso all'inizio della
sezione, che il pavimento di genericità corregge; \code{highs\_survey\_prior} attiva il pavimento
con il valore predefinito $w = 0.2$.
