...
\begin{warnbox}{Differenza rispetto ai modelli quadratici}
Nei modelli risolti con Gurobi, dove l'obiettivo è quadratico, le penalità sono scalate per
$p_i^2$ anziché per $p_i$, per essere commensurabili con l'errore \emph{quadratico}. Le due
famiglie di modelli condividono struttura e vincoli ma \textbf{non i valori numerici dei
coefficienti}, che non sono trasferibili dall'una all'altra.
\end{warnbox}
