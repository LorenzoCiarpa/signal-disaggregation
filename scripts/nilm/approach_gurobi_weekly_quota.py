"""
Day-wise Gurobi NILM with a weekly activation quota carried across days.

Builds on approach_gurobi_soft_duration (soft duration limits, always-on as variables)
